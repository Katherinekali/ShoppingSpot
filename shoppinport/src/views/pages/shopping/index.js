...
class Shopping extends React.Component {
    ...
    operate(cartList) {
        ...
        if (!edit) {
            ...
            if (!cartList) return Toast.loading('没有商品');
            let ids = []
            cartList.forEach(item => {
                if (item.isDelete) {
                    ids.push(item.product_id)
    ...
    render() {
        ...
        return <div className="shopCar" ref="load">
            ...
            {
                cartList && cartList.length > 0 ? <div className="shopCar_content">
